    ...
    <div class="row" id="footerBlock">
        <div  class="cmsspot col-xs-12 col-sm-5">
            <div id="footernewsletter">
                ...
                $oViewRenderer->addMapperFromIdentifier('chameleon_system_newsletter.mapper.quick_signup');
        ...
        <div class="cmsspot col-xs-12 col-sm-3">
            ...
            <div id="footeraux">
                <a title="<?= $translator->trans('chameleon_system_chameleon_shop_theme.layout.footer_print_page'); ?>" href="#" onclick="window.print(); return false;" class="snippetLinkStylesIcon cmsBtn-small">
                    <i class="linkimage i i-print">&nbsp;</i><span class="link">&nbsp;<?= $translator->trans('chameleon_system_chameleon_shop_theme.layout.footer_print_page'); ?></span>
                </a>
                <a title="<?= $translator->trans('chameleon_system_chameleon_shop_theme.layout.footer_jump_top'); ?>" href="#top" class="snippetLinkStylesIcon cmsBtn-small">
                    <i class="linkimage i i-pointer-up">&nbsp;</i><span class="link">&nbsp;<?= $translator->trans('chameleon_system_chameleon_shop_theme.layout.footer_jump_top'); ?></span>
                </a>
            </div>
            <div id="footertrust">
                <?php
                ...
                echo $oViewRenderer->Render('pkgShopRatingService/ekomi/widget.html.twig');
                ?>
            </div>
        </div>
    </div>
