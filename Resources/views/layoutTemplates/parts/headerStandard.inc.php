    ...
    <div class="container">
        <div class="row">
            ...
            <div id="headinfo1" class="hidden-xs col-sm-2 cmsspot">
                ...
                $oViewRenderer->AddSourceObjectsFromArray(array('sImage' => '<img class="icon" src="'.TGlobal::GetStaticURL('/bundles/chameleonsystemchameleonshoptheme/images/sprite/header_image_one.png').'" style="float: left;" alt="'.TGlobal::OutHTML(TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_shipping')).'">', 'sText' => TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_shipping'), 'aLink' => array('sLinkURL' => \ChameleonSystem\CoreBundle\ServiceLocator::get('chameleon_system_shop.shop_service')->getActiveShop()->GetLinkToSystemPage('customerservice-shipping'), 'sTitle' => TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_shipping'))));
            ...
            <div id="headinfo2" class="hidden-xs col-sm-2 cmsspot">
                <?php
                $oViewRenderer = new ViewRenderer();
                $oViewRenderer->AddSourceObjectsFromArray(array('sImage' => '<img class="icon" src="'.TGlobal::GetStaticURL('/bundles/chameleonsystemchameleonshoptheme/images/sprite/header_image_two.png').'" style="float: left;" alt="'.TGlobal::OutHTML(TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_product_return')).'">', 'sText' => TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_product_return'), 'aLink' => array('sLinkURL' => \ChameleonSystem\CoreBundle\ServiceLocator::get('chameleon_system_shop.shop_service')->getActiveShop()->GetLinkToSystemPage('product-returns'), 'sTitle' => TGlobal::Translate('chameleon_system_chameleon_shop_theme.layout.header_product_return'))));
                echo $oViewRenderer->Render('/common/textTeaser/textTeaserImageTextLink.html.twig');
                ?>
            </div>
