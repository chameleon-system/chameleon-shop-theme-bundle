...
?>
  <div class="userinput">
    <table summary="">
      <tr>
        <th><?=TGlobal::OutHTML(TGlobal::Translate('chameleon_system_chameleon_shop_theme.extranet.form_email')); ?><span class="required">*</span></th>
        <td>
      ...
      <tr>
        <td colspan="2"><label><input class="plain" type="checkbox" checked="checked" value="Register" name="module_fnc[<?=TGlobal::OutHTML($oExtranetConfig->fieldExtranetSpotName); ?>]" /> <?=TGlobal::Translate('chameleon_system_chameleon_shop_theme.extranet.form_create_account'); ?></label></td>
      </tr>
      <tr>
      ...
      <tr>
        <th><?=TGlobal::OutHTML(TGlobal::Translate('chameleon_system_chameleon_shop_theme.extranet.form_password_check')); ?><span class="required">*</span></th>
        <td>
