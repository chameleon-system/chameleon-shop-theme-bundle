...
$oViewRenderer->AddSourceObject('sTitle', TGlobal::Translate('chameleon_system_chameleon_shop_theme.extranet.reset_password_header'));
$oViewRenderer->AddSourceObject('sText', TGlobal::Translate('chameleon_system_chameleon_shop_theme.extranet.reset_password_help'));
